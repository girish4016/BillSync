...
function Settings() {
    return (
        <section className="p-2 sm:p-2 lg:p-3 bg-slate-50 w-full h-screen overflow-auto">
                        ...
                        <div className="flex flex-col lg:flex-row gap-2 sm:gap-3 flex-grow">
                            ...
                            <div className="w-full lg:w-1/2 flex flex-col gap-2 sm:gap-3">
                                <div className="flex flex-col">
                                    ...
                                    <Input id="picture" type="file" className="w-full sm:w-1/2 border border-stone-400" />
                                ...
                                <div className="flex flex-col">
                                    <span className="text-slate-700 pb-1 sm:pb-1.5">Mobile Number</span>
                                    <Input className="w-full sm:w-2/3 lg:w-1/2 text-sm py-1 sm:py-2 lg:py-2.5 border border-stone-400" />
                                </div>
                            </div>
                            ...
                            <div className="w-full lg:w-1/2 flex flex-col gap-2 sm:gap-3">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-gray-400 text-sm">Ensure your account is using a long, random password to stay secure.</span>
                                </div>

                                <div className="flex flex-col">
                                    <span className="text-slate-700 pb-1 sm:pb-1.5">Current Password</span>
                                    <Input type="password" className="w-full sm:w-2/3 lg:w-1/2 text-xs py-1 sm:py-2 lg:py-2.5 border border-stone-400" />
                                </div>

                                <div className="flex flex-col">
                                    <span className="text-slate-700 pb-1 sm:pb-1.5">New Password</span>
                                    <Input type="password" className="w-full sm:w-2/3 lg:w-1/2 text-xs py-1 sm:py-2 lg:py-2.5 border border-stone-400" />
                                </div>
                                ...
                                <div className="flex flex-col">
                                    <span className="text-slate-700 pb-1 sm:pb-1.5">Once your account is deleted, all of its resources and data will be permanently deleted. Before deleting your account, please download any data or information that you wish to retain.</span>
                                    <ConfirmDialog btnTitle="Delete Account" btnClass="w-full sm:w-1/2 lg:w-1/3 bg-red-600" DialogDescription="This action cannot be undone. This will permanently delete your account and remove your data from our servers." />
                                </div>
                            </div>
                        </div>

                        <div className="flex flex-row justify-between gap-2 sm:gap-3 mt-4">
                            <ConfirmDialog btnTitle="Save Changes" btnClass="w-full sm:w-auto" DialogDescription="This action cannot be undone. This will permanently update your account details." />
